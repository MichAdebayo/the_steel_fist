        ...
        with cols[idx % 2]:
            ...
            <div style="background: rgba(45,45,45,0.95); padding:1.5rem; border-radius:16px; box-shadow:0 8px 32px rgba(0,0,0,.3); backdrop-filter:blur(10px); border:1px solid rgba(255,255,255,0.1); margin:1rem 0; color:#ffffff;">
                <div style="display:flex; justify-content:space-between; align-items:flex-start; gap:1rem;">
                    <div style="flex:1;">
                        <h3 style="margin:0 0 .45rem 0; font-size:1.35rem; font-weight:600; letter-spacing:.5px;">{course['course_name']}</h3>
                        <p style="color:#cccccc; margin:.25rem 0; font-size:.85rem;">Coach: {course['coach_name']}</p>
                        <p style="color:#cccccc; margin:.25rem 0; font-size:.85rem;">Specialty: {course['coach_specialty']}</p>
                        <p style="color:#cccccc; margin:.25rem 0; font-size:.85rem;">Date: {formatted_date}</p>
                        <p style="color:#cccccc; margin:.25rem 0; font-size:.85rem;">Time: {formatted_time}</p>
                        <p style="color:#cccccc; margin:.25rem 0; font-size:.85rem;">Capacity: {current}/{total}</p>
